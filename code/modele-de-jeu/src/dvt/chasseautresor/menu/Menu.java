package dvt.chasseautresor.menu;
...
import static dvt.chasseautresor.menu.ConstantesMenu.*;

import dvt.chasseautresor.menu.action.Action;
import dvt.chasseautresor.menu.action.DownAction;
import dvt.chasseautresor.menu.action.UpAction;
...
public class Menu extends Fenetre {
    ...
    public Menu() {
       ...
       //this.getSIVOX().playWav(ACCUEIL_SON);
        ...
        addMenu("Jouer", new Action(this, 1));
        addMenu("Règles", new Action(this, 2));
        addMenu("Options", new Action(this, 3));
    ...
    public void loop() {
        ...
        while (this.isDisplayable()) {
            ...
            if (gameChoice != 0) {
                ...
                try {
                    timeLoop = (lastLoopTime - System.nanoTime() + ConstantesDevint.OPTIMAL_TIME) / 1000000;
                    if (timeLoop > 0) {
