...
public final class ConstantesDevint {
    ...
    public static final String WIN_SON = "../ressources/sons/win.wav";

    public static final String FONT_TYPE_DEFAULT = "Arial";
    public static final int TAILLE_DEFAULT = 50;
    public static final long OPTIMAL_TIME=1000000000L;
    ...
    public static final int SHIP_MAXDISTANCE = 1000;
