...
import static dvt.chasseautresor.menu.ConstantesMenu.BORDURE_SELECTED_DEFAULT;
import static dvt.chasseautresor.menu.ConstantesMenu.BORDURE_SIZE_SELECTED_DEFAULT;
import static dvt.chasseautresor.menu.ConstantesMenu.BORDURE_SIZE_UNSELECTED_DEFAULT;
import static dvt.chasseautresor.menu.ConstantesMenu.BORDURE_UNSELECTED_DEFAULT;
...
public abstract class Fenetre extends JFrame {
    ...
    private transient JukeBox jukeBox;
    ...
    private static final java.awt.Color[] BACKGROUND_DEFAULT = {new Color(189,204,242), new Color(252,241,141),new Color(178,218,199), new Color(250,179,151),new Color(203,204,192)};
    private static final java.awt.Color[] FOREGROUND_DEFAULT = {Color.BLACK,Color.BLACK,Color.BLACK,Color.BLACK,Color.BLACK };
    private static final java.awt.Color[] BUTTON_BACKGROUND_SELECTED_DEFAULT = {Color.BLACK, new Color(0,40,79),new Color(199,44,72),new Color(43,164,130),new Color(174,2,0)};
    private static final java.awt.Color[] BUTTON_FOREGROUND_SELECTED_DEFAULT = {Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE, Color.WHITE };
    private static final java.awt.Color[] BUTTON_FOREGROUND_UNSELECTED_DEFAULT = {Color.BLACK, Color.BLACK, Color.BLACK, Color.BLACK, Color.BLACK };
    private static final java.awt.Color[] BUTTON_BACKGROUND_UNSELECTED_DEFAULT = {Color.WHITE,  new Color(215,238,241),Color.WHITE, new Color(187,230,210),new Color(249,214,203) };
